...
# 
# laplace equation
# concentric balls around center (0, 0) - neumann on inner disk and drichlet on outer disk
...
# Drichlet BC u = 0 and Neumann BC
...
def plot_eigenfunctions(domain, V, eigensolver, A, nev_to_plot):
    ...
    for i in range(nev_to_plot):
        ...
        subplotter.add_mesh(contours, color="blue", line_width=1.5)
        subplotter.view_xy()
